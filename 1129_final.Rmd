...
```{r}
rsconnect::setAccountInfo(name='yukgeon98527',
			  token='9ED5829B6F025978C75A9EC3DE532CAF',
			  secret='rkuYxesnflm1HJ6rriu2wGVo2w8WOUNNv11FYHBm')
library(rsconnect)
...
```{r include=FALSE}
# file.choose()
DATA3 = read_excel("D:/3-1 Rshiny/teamplay/final/sales4.xlsx")
DATA2 = read_excel("D:/3-1 Rshiny/teamplay/final/sales.xlsx")
DATA = read_excel("D:/3-1 Rshiny/teamplay/final/test1129.xlsx")
```
